...
const DocumentationNavigation = () => (
  <nav aria-label='Documentation navigation' className='space-y-6 text-sm'>
    ...
    <div>
      <a href='#rules' className='text-base font-semibold hover:underline'>
        Diagnostics
      </a>
      <ul className='mt-3 space-y-4 border-l pl-3'>
      ...
      <div className='mx-auto max-w-6xl px-6 py-12 lg:grid lg:grid-cols-[14rem_minmax(0,1fr)] lg:gap-12 lg:py-16'>
        ...
        <main className='min-w-0 leading-[1.75]'>
          ...
          <section aria-labelledby='configuration' className='mt-12'>
            <h2
              id='configuration'
              className='scroll-mt-6 text-2xl font-semibold tracking-tight'
            >
              Configuration
            </h2>
          ...
          <section aria-labelledby='rules' className='mt-16 border-t pt-12'>
            <h2
              id='rules'
              className='scroll-mt-6 text-2xl font-semibold tracking-tight'
            >
            ...
            {ruleGroups.map((group) => (
              ...
              >
                <h3
                  id={group.id}
                  className='scroll-mt-6 border-b pb-3 text-xl font-semibold tracking-tight'
                >
                  {group.title}
                </h3>
                {group.rules.map((rule) => (
                  <article
                    ...
                    className='scroll-mt-6 border-b py-8 last:border-b-0 last:pb-0'
                  >
