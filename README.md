...
- Diagnostics on every change, catching syntax errors, unknown recipes, bad
  ...
  the [rule documentation](docs/features/analysis) for the full list of rules.
...
is keyed by its code (see the [rule documentation](docs/features/analysis)) and
...
Rule codes are listed in the [rule documentation](docs/features/analysis).
