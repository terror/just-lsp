...
pub(crate) fn required_args_for_function(function_name: &str) -> usize {
  match function_name {
    "absolute_path"
    | "blake3"
    | "blake3_file"
    ...
    | "which"
    | "without_extension" => 1,
    "append" | "choose" | "prepend" | "semver_matches" | "trim_end_match"
    | "trim_end_matches" | "trim_start_match" | "trim_start_matches" => 2,
